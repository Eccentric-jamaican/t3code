        ...
        (() => {
          ...
          return (
            <div className="flex justify-end">
              <div className="group relative max-w-[80%] rounded-2xl rounded-br-sm border border-border bg-secondary px-3 py-2">
                {userImages.length > 0 && (
                ...
                {row.message.text && (
                  <pre className="whitespace-pre-wrap wrap-break-word font-mono text-sm leading-[1.45] text-foreground">
                    {row.message.text}
                  </pre>
                )}
